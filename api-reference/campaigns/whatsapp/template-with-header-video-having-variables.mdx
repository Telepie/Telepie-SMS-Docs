---
title: Template with Header Video & Having Variables
description: "This endpoint is for video-header templates with customizable parameters, simple integration, versatile customization."
api: "POST /whatsapp"
playground: true
---
