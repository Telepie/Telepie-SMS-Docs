---
title: Template with Header Text & Having Variables
description: "This endpoint is for text-header templates with customizable parameters, simple integration, versatile customization."
api: "POST /whatsapp"
playground: true
---
...
<ParamField path="Type(header type text)" type="string" required>
