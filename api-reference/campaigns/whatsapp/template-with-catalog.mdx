...
description: "This endpoint is for template having catalog templates, use this endpoint with customizable parameters for seamless integration and personalization."
api: "POST /whatsapp"
playground: true
---

Use this endpoint to send a WhatsApp template message that includes a product catalog.
