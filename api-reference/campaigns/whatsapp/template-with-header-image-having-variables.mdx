---
title: Template with Header Image & Having Variables
description: "This endpoint is for image-header templates with customizable parameters, simple integration, versatile customization."
api: "POST /whatsapp"
playground: true
---
...
<ParamField path="Type(header type image)" type="string" required>
